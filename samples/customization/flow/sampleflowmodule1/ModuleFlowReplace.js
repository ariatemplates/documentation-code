Aria.classDefinition({
    $classpath : 'samples.customization.flow.sampleflowmodule1.ModuleFlowReplace',
    $extends : 'aria.templates.FlowCtrl',
    $implements: ['samples.customization.flow.sampleflowmodule1.IModuleFlow'],
    $constructor:function() {
        this.$FlowCtrl.constructor.call(this);
        this.flowInitialized = false;
    },
    $prototype: {
        $publicInterfaceName: 'samples.customization.flow.sampleflowmodule1.IModuleFlow',
        ...
        oninitCallback : function (param) {
            if(!this.flowInitialized){
                this.initializeFlow(param);
            }

        },

        initializeFlow : function (param) {
        ...
        ongetFlightAvailabilityCallback:function() {
            ...
            //var mcd=this.flowData; // this.data contains the data model
