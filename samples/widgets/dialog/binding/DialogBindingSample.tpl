{Template {
  ...
  {macro main()}
    ...
    {@aria:Dialog {
      ...
      bind : {
        ...
        "title" : { inside : data, to : 'dialogTitle' }
      },
      onOpen : dialogOpen,
  ...
  {macro aboutToBeClosed()}
    <div style="padding:10px;">
      <h1> Closing in 2 seconds </h1>
      <p>This dialog is about to be closed!</p>
    </div>
  {/macro}
  ...
  {macro dialogTitle()}
    <div style="padding:10px;">
      ...
      {@aria:TextField {
        ...
        label : "Dialog title",
        bind : {
          value : { to : 'dialogTitle', inside : data }
        }
      }/}
    </div>
    {call popupContentButtons()/}
  ...
  {macro infoCloseButton( )}
    <div style="padding:10px;">
      <h1> Close button </h1>
      The dialog close button ( X ) and a close button inside the dialog can share the same callback , as shown in the following example : <br /> <br />
      {@aria:Button {
        id : "toFocus",
