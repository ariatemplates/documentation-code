Aria.tplScriptDefinition({
    ...
    $prototype : {
        ...
        onModuleEvent : function (evt) {
            return;
            if (evt.name == "methodCallBack") {
                alert(123);
            }
            if (evt.name == "methodCallEnd") {
                if (evt.method == "xloadDataset" || evt.method == "createNewDataset" || evt.method == "copyDataset"
        ...
        /**
         * Event Handler called when a scrollbar is used Will change the content scroll and synchronize all scrollbars
         */
        ...
        onDsDataCellClick : function (evt) {
            ...
            if (id == "TABLE")
                return; // event did not hapen in a cell
         ...
         * @param {Object} itm the item passed as argument of each Repeater childSection callback cf. Repeater
         * documentation
         */
